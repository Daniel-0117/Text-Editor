...
## Description
The purpose of this project is to have a text editor that can retain notes or code snippets with or without an internet connection.

## Usage
The user has to go to the deployed site. Once there all the user has to do is press the install button at the top left. Then go on and use at your whim.
